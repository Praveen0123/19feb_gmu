...
@Component({
  selector: 'gmu-mason-splash-list-mobile',
  templateUrl: './mason-splash-list-mobile.component.html',
  styleUrls: ['./mason-splash-list-mobile.component.scss']
})
export class MasonSplashListMobileComponent implements OnInit
{
  ...
  ngOnInit(): void
  {
    ...
    this.novaIcon = CONFIG.IMAGES.SPLASH_PAGE.NOVA_COLOR;
    this.novaIconNColor = this.novaIcon;


    this.gmuIcon = CONFIG.IMAGES.SPLASH_PAGE.GMU_COLOR;
    this.gmuLogoNColor = this.gmuIcon;

    this.vpIcon = CONFIG.IMAGES.SPLASH_PAGE.VP_COLOR;
    this.vpIconNColor = this.vpIcon;

    this.bgIcon = CONFIG.IMAGES.SPLASH_PAGE.BG_COLOR;
    ...
    this.skillfocusBg = CONFIG.IMAGES.SPLASH_PAGE.STELLAR_SKILLS;
    ...
    this.coachingIcon = CONFIG.IMAGES.SPLASH_PAGE.COACHING;
    this.buildDetails();
  }
  ...
  private buildDetails()
  {
    ...
    this.detailsList = [
      ...
      'Help Students Plan and Persist',
    ...
    this.platforms = [
      ...
      'Tools to encourage student persistence and planning',
    ...
    this.coaching = [
      ...
      { Lable: 'Assist', Description: 'Coaches and students both have access to a student’s visual course planner to have relevant conversations about course loads, course requirements, and personal demands to help ensure academic success.' },
